...
class Comment_selectbymusic extends CI_Controller {
  public function index() {
      ...
      try{
        if(!(array_key_exists('MusicId',$_GET)&&array_key_exists('UserId',$_GET))){
      ...
      try {
        if(array_key_exists('Start',$_GET)){
          $result = $this->Comment_model->getCommentByMusic($_GET['MusicId'],$_GET['Start']);
        }
        else{
          $result = $this->Comment_model->getCommentByMusic($_GET['MusicId']);
        }
